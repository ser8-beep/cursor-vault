    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Globe dock anchor — bottom-center of notes stage (Figma 2034:14169 rest pose) */}
          <div
            ref={dockTargetRef}
            aria-hidden="true"
            data-name="sculpture-dock-target"
            className="pointer-events-none absolute bottom-0 left-1/2 h-8 w-px -translate-x-1/2"
          />
        </motion.div>
      </section>
    );
