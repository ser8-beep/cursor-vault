...
export function HomeScrollExperience() {
  ...
  /** Handoff runs on all viewports when motion is allowed (not mobile-only). */
  const internalScrollEnabled = !reducedMotion;
    ...
    <div className="canvas-pattern flex min-h-screen flex-col gap-gap-md p-canvas overflow-x-clip">
      ...
      <SculptureStickyParallax
        ...
        suppressDuringHandoff={
          ...
          (internalScroll.isActive || internalScroll.phase === "active")
        }
      />
    </div>
  );
